...
namespace Tweening
{
    ...
    {
        [Sync]
        public ObservableDictionary<int, Player> Players { get; set; }
        ...
        /// MonoSync will use the default constructor if no <see cref="SyncConstructorAttribute"/> Marked constructor is provided.
