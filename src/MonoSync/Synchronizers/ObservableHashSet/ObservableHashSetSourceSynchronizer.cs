...
{
    public class ObservableHashSetSourceSynchronizer<TKey> : SourceSynchronizer
    {
        ...
        public Collections.ObservableHashSet<TKey> BaseObject => (Collections.ObservableHashSet<TKey>) Reference;
