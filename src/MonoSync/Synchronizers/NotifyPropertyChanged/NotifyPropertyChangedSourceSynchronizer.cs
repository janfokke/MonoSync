...
{
    public class NotifyPropertyChangedSourceSynchronizer : SourceSynchronizer
    {
        ...
        public NotifyPropertyChangedSourceSynchronizer(SourceSynchronizerRoot sourceSynchronizerRoot, int referenceId,
            ...
            base(sourceSynchronizerRoot, referenceId, reference)
        {
            ...
            _propertyCollection = sourceSynchronizerRoot.GetPropertiesFromType(baseType);
